...
function DiamondInformation() {
  ...
  const diamonds = [
    ...
    { image: SanHo, name: "SanHo" },
    { image: Zircon, name: "Zircon" },
    { image: Tanzanite, name: "Tanzanite" },
  ];
        ...
        {diamonds.map((item, index) => (
          ...
          >
            <div className="w-full md:w-1/2 flex justify-center">
              <div
                className={`bg-zinc-300 h-64 w-full max-w-sm rounded-lg shadow-md cursor-pointer transform transition-transform duration-300 ${
